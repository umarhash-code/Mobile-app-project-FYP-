...
class OfflineAIMoodDetectionService {
  ...
  static Future<MoodDetectionResult> detectMood(String text) async {
    if (!_initialized) {
      await initialize();
    }
  ...
  /// Detect moods for multiple texts
  static Future<List<MoodDetectionResult>> detectMoodsBatch(
  ...
  static Map<String, double> getMoodStatistics(
      List<MoodDetectionResult> results) {
